...
import { EmployeeFormData, FormProps } from './types'

export const Form: React.FC<FormProps> = ({ employee, token }) => {
  ...
  const onSubmit = async (payload: EmployeeFormData) => {
    try {
      const { data } = await internalAPIInstance.employee.updateEmployee(
        employee.employeeId,
        payload,
        token
      )
      ...
      toast.success('Funcionário atualizado com sucesso!', {
        description: `${data.fullName} foi atualizado no sistema`
      })
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              ...
              <fieldset className="space-y-2">
                ...
                <Select
                  ...
                  defaultValue={employee?.giftSize}
                  name="giftSize"
                >
                  <SelectTrigger
